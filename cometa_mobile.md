...
<photo> Arrow pointing to the Start Mobile button </photo>

Click on Start Mobile.
<photo> Image showing the click on the Start button </photo>

Additionally, you can install an APK package for the mobile device.
<photo> Arrow pointing to the selection of the APK package </photo>
...
Select the mobile device component.
Start the mobile device, similar to what you do in the Feature section.
